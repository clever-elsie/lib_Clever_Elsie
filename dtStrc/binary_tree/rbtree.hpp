...
class rbtree{
	...
	// iterator
	iterator begin(){ return iterator(this,cur_size?min_max(root,false):nil); }
	iterator end(){ return iterator(this,nil); }
	reverse_iterator rbegin(){ return reverse_iterator(this,cur_size?min_max(root,true):nil); }
