...
template<class T,size_t M=998244353,size_t psz=2>
class convolution{
    ...
    static constexpr array<size_t,11>mods{
          167'772'161/* 5 * 2^25 +1*/,  469'762'049/* 7 * 2^26 +1*/,
        1'107'296'257/*33 * 2^25 +1*/,1'711'276'033/*51 * 2^25 +1*/,
        1'811'939'329/*27 * 2^26 +1*/,2'013'265'921/*15 * 2^27 +1*/,
        2'113'929'217/*63 * 2^25 +1*/,2'281'701'377/*17 * 2^27 +1*/,
        2'483'027'969/*37 * 2^26 +1*/,2'717'908'993/*81 * 2^25 +1*/,
        2'885'681'153/*43 * 2^26 +1*/
    };
    template<size_t... I>
    vector<T>prod_impl(const vector<T>&a,const vector<T>&b,const size_t len,index_sequence<I...>)const{
        ...
        for(int32_t i=0;i<psz;++i)m[i]=mods[i];
